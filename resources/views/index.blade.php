                    ...
                    <div class="owl-stage-outer">
                        <div class="owl-stage">
                            ...
                            <div class="owl-item px-2 m-auto">
                              <img  src="{{$prestation->image()}}" class="w-100" id="imgPrestasi">
                                 <div class="card">
                                     <div class="card-body text-left">
                                         <h5><b><a href="#" class="text-decoration-none">{{$prestation->name}}</a></b></h5>
                                         <p style="word-wrap: break-word;">{!! \Str::limit($prestation->content, 122, '..') !!}</p>
                                     </div>
                                 </div>
                            </div>
                            @endforeach
                  ...
                  <div class="col-md-4 down">
                      ...
                      <div class="card">
                          <div class="card-body">
                           ...
                           <p style="word-wrap: break-word;">{!! \Str::limit($article->content, 205, '..') !!}</p>
